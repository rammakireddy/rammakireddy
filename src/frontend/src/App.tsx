      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            End-to-end visual technology solutions tailored for advanced
            industry requirements across the world.
          </p>
        </div>
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <p className="text-muted-foreground mb-8 leading-relaxed text-center">
            ...
            VR, AR, MR, Visual Simulation, Digital Twin, and AI/ML technologies,
            as well as developing electronic interfaces for simulators. Join a
            team building cutting-edge solutions across defence, aerospace,
            engineering, mining, healthcare, transport, and other advanced
            industries.
          </p>
          <div className="bg-card border border-border rounded-xl p-10 card-glow text-center">
            ...
            <a href="mailto:jobs@simlabs.in">
              <Button className="btn-gradient text-white gap-2">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            ...
            Reach out to the <span className="gradient-text">SIMLABS</span>
            <sup className="text-xs">®</sup> team today.
          </p>
        </div>
